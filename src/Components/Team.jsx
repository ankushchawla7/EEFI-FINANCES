        ...
        <>
            <section className='Team-section '>
                <Container className='custom_container'>
                    <h2 className='fs-46 ff-machine-light fw-bold line-120 text-capitalize text-white text-center pt-132 pb-73'>our Team</h2>
                            ...
                            <div className="card-box d-flex flex-column gap-20">
                                ...
                                <div className='d-flex flex-column align-items-center gap-20'>
                                    ...
                                    <div className='d-flex gap-3 align-items-center'>
                                        <a href="https://twitter.com/?lang=en" target='blank' className='social-link'><Twitter /></a>
                                        <Line />
                                        <a href="https://discord.com/" target='blank' className='social-link'> <Discord /></a>
                                    </div>
                                </div>
                            ...
                            <div className="card-box d-flex flex-column gap-20">
                                ...
                                <div className='d-flex flex-column align-items-center gap-20'>
                                    ...
                                    <div className='d-flex gap-3 align-items-center'>
                                        ...
                                        <a href="https://discord.com/" target='blank' className='social-link'> <Discord /></a>
                                        <Line />
                                        <a href="https://in.linkedin.com/" target='blank' className='social-link'> <Linkdin /></a>
                                    </div>
                                </div>
