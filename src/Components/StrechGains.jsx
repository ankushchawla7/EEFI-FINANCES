...
const StrechGains = () => {
    return (
        <>
            <section className='strechgains-bg min-md-vh-100 d-flex flex-column'>
                <h2 className='ff-jakarta fs-52  fw-bold lin-120 text-white text-center py-4 mb-0'>Amplify and stretch gains</h2>
                ...
                {/* <img src={Cloud} alt="cloud-img" className='w-100' /> */}
            </section>
        </>
    )
}
