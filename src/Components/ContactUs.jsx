        ...
        <>
            <section className='contact-bg'>
                <Container className='custom_container contact-py'>
                    <h2 className='text-white ff-machine-ultrabold fw-bold text-center text-capitalize line-120 '>Contact Us</h2>
                    <p className='fs-16 fw-normal ff-raleway line-160 text-white op8 text-center'>Have a question or want to contribute? Reach out to us.</p>
