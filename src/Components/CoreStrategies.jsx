...
const CoreStrategies = () => {
    ...
    return (
        <>
            <section className='strategies-bg py-178 position-relative'>
                <Container className='custom_container'>
                    <h2 className='fs-46 fw-bold ff-machine-light text-white line-120 text-capitalize text-center'>Core Strategies</h2>
                    ...
                    <Slider {...settings}>
                        <Row className='d-flex justify-content-lg-between justify-content-center align-items-center'>
                            ...
                            <Col lg={7}>
                                <h3 className='text-white'>Elastic Vault</h3>
                                <div className='d-flex gap-2 align-items-center'>
                                    <p className='text-white mb-0'>Deposit Token</p>
                                ...
                                <p className='text-white'> $AMPL</p>
                                <h5 className='text-white'>Flagship Hedging Strategy</h5>
                                <p className='text-white'>This one-of-a-kind strategy combines the benefits of Rebase’s force multiplier effect and Real Yield’s sustainability.</p>
                                <p className='text-white'>Helps users to protect against downtrends and amplify yield rewards during market up trends.</p>
                            </Col>
                        </Row>
                        <Row className='d-none d-lg-flex justify-content-between align-items-center'>
                            <Col lg={4}>
                                <img src={SliderImage} alt="slider-card" className='w-100 bradi-12' />
                            </Col>
                            <Col lg={7}>
